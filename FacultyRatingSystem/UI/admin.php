    ...
    <div class="content">
      ...
      <div class="card">
            ...
            <div class="card-body table-responsive">
              <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#admin">Add Admin</button>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php include 'FacultyRatingSystem/UI/UIDynamics/Admin/admin.php'; ?>
                </tbody>
                <tfoot>
                <tr>
                  <th>Name</th>
...
<?php include 'FacultyRatingSystem/UI/UIDynamics/Admin/modal.php'; ?>
