    ...
    <div class="content">
      ...
      <div class="card">
            ...
            <div class="card-body table-responsive">
              <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#subject">Add Subject</button>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php include 'FacultyRatingSystem/UI/UIDynamics/Subject/subject.php'; ?>
                </tbody>
                <tfoot>
                <tr>
                  <th>Subject</th>
...
<?php include 'FacultyRatingSystem/UI/UIDynamics/Subject/modal.php'; ?>
