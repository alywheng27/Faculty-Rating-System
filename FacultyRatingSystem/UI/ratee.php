  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ratee</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Ratee</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="content">
      ...
      <div class="card">
            <div class="card-header">
              <h3 class="card-title">Ratee</h3>
            </div>
            
            <div class="card-body table-responsive">
              <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#ratee">Add Ratee</button>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php include 'FacultyRatingSystem/UI/UIDynamics/Ratee/ratee.php'; ?>
                </tbody>
                <tfoot>
                <tr>
                  <th>ID Number</th>
...
<?php include 'FacultyRatingSystem/UI/UIDynamics/Ratee/modal.php'; ?>
    ...
    $.ajax({
      ...
      success: function(data){
        if(data == 'RateeAdded'){
          ...
          toastr.success('Ratee Added.');
        }

        if(data == 'RateeUpdated'){
          const Toast = Swal.mixin({
            toast: true,
            position: 'center',
            showConfirmButton: false,
          ...
          toastr.info('Ratee Updated.');
        }

        if(data == 'RateeDeleted'){
          const Toast = Swal.mixin({
            toast: true,
            position: 'center',
            showConfirmButton: false,
